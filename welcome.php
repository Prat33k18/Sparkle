...
<header>
    ...
    <div class="song_side">
        <nav>
            ...
            <div class="user">
                <img src="logo.png" alt="User" title="">
            </div>
        </nav>
        <div class="content">
        ...
        <div class="popular_artists">
            ...
            <div class="item">
                <li>
              <a href="arijit.php"><img src="img/arjit.jpg" alt="Arjit Singh" title="Arjit Singh"></a>
                </li>
                <li>
               <a href="spb.php"><img src="img/spb.jpg" alt="SPB" title="SPB"></a>
                </li>
                <li>
